...
class Material:
    ...
    Atributos:
        ...
        ir (Float): O índice de refração determina como a luz se comporta ao atravessar a interface entre dois materiais diferentes.
    """
    def __init__(self, color: Color = Color(), ambient=0.2, difusion=1.0, specular=0.5,
                 roughness=100.0, reflection=0, transmission=0, ir=1.0):
        self.color = color
